...
class dxcc:
    ...
    TRACE2 = 5
    VERBOSE = DEBUG
    def __init__(self, CTYFILES_PATH, CTYFILES_URL, AUTOFETCH_FILES, VERBOSE=3):
        self.CTYFILES_PATH = CTYFILES_PATH
    ...
    def date_country_tab(self, date = None):
        ...
        try:
            open(self.CTYFILES_PATH + 'country.tab', "r")
        except FileNotFoundError:
            self.fetch_country_files()
            self.process_country_files()
        with open(self.CTYFILES_PATH + 'country.tab', "r", encoding='utf-8') as countrytab:
